...
\begin{definition}
$A,B$を集合とする。$A$が$B$の部分集合とは、$A$の全ての要素が$B$に含まれている時のことである。これを$A\subseteq B$と書く。
\end{definition}

\begin{example}
偶数全ての集合は整数全ての集合の部分集合。もっとわかりやすく、有限の要素を持つ集合については
\begin{equation*}
...
\begin{definition}
連結グラフが閉路グラフを部分グラフとしてもたないとき、これを木という。
\begin{center}
\begin{figure}[h]
	\centering
...
\:\\\:
\begin{remark}
木の便利な性質の一つに、新しい辺を足すと閉路グラフがことです。例えば$E,F$に辺を足すと$B,E,F$が閉路グラフ$C_3$となります。
\end{remark}
...
\begin{theorem}
もしあるグラフが連結グラフなら、そのグラフは全域木を部分グラフとして持つ。
\end{theorem}
